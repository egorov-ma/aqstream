...
- [ ] Создана корневая структура директорий согласно документации
...
- [ ] Команда `./gradlew build` успешно выполняется (пустой проект)
...
- [ ] Структура соответствует документации в `docs/`
- [ ] Code review пройден
