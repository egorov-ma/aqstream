...
- [ ] Кнопка «Повторно отправить билет» в Telegram *(заблокировано: notification-service)*
...
- [ ] Привязка/отвязка Telegram *(заблокировано: notification-service)*
- [ ] Аватар (загрузка) *(заблокировано: media-service)*

### Настройки уведомлений *(заблокировано: notification-service)*

- [ ] Toggle для типов уведомлений
- [ ] Напоминания о событиях (on/off)
- [ ] Обновления регистраций (on/off)

### Организации *(Out of Scope: Phase 3)*

- [ ] Список организаций, где пользователь член
- [ ] Для каждой: роль, кнопка перейти в dashboard
- [ ] Кнопка «Создать организацию» → запрос

### Группы *(Out of Scope: Phase 3)*
...
- [ ] Все Acceptance Criteria выполнены *(частично: 13/21, остальные заблокированы)*
- [x] Responsive design
