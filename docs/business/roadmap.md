...
Каждая фаза декомпозируется на конкретные задачи в директории [to-dos](../to-dos/README.md):
...
- [ ] Регистрация через Telegram (основной способ)
- [ ] Регистрация по email (альтернативный способ)
- [ ] Вход через Telegram / email+password
...
- [ ] Запрос на создание организации + одобрение админом
- [ ] Приглашение членов через Telegram
- [ ] Роли: Владелец (Owner), Модератор
- [ ] Переключение между организациями
- [ ] Группы для приватных событий (создание, инвайт-коды)
...
- [ ] Шаблоны сообщений
- [ ] Подтверждение регистрации (билет с QR)
...
| Phase 2: Core | 🟡 Готова к работе | [20 задач](../to-dos/README.md#phase-2-core--список-задач) |
