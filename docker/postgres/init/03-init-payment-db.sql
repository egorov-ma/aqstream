...
GRANT USAGE ON SCHEMA payment_service TO aqstream_app;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA payment_service TO aqstream_app;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA payment_service TO aqstream_app;
ALTER DEFAULT PRIVILEGES IN SCHEMA payment_service GRANT ALL PRIVILEGES ON TABLES TO aqstream_app;
ALTER DEFAULT PRIVILEGES IN SCHEMA payment_service GRANT ALL PRIVILEGES ON SEQUENCES TO aqstream_app;
