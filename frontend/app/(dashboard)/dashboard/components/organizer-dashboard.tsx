...
/**
 * Дашборд для организатора (Owner/Moderator).
 * Показывает статистику организации, ближайшие события и быстрые действия.
 */
    ...
    return (
      <div className="flex flex-col gap-4">
        <h1 className="text-2xl font-bold">
          Обзор {currentOrganization && `• ${currentOrganization.name}`}
        </h1>
        <Card>
    ...
    <div className="flex flex-col gap-4">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Управление событиями организации</CardDescription>
        </CardHeader>
