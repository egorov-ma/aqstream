package ru.aqstream.analytics.controller;
...
/**
 * Контроллер системной информации Analytics Service.
...
public class SystemController {
     ...
     *
     * @return информация о версии Analytics Service
     */
    @Operation(
        summary = "Получить версию сервиса",
        description = "Возвращает информацию о версии Analytics Service (build time, git commit, версии)"
    )
