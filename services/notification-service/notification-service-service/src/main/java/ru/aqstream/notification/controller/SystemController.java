...
/**
 * Контроллер системной информации Notification Service.
...
public class SystemController {
     ...
     *
     * @return информация о версии Notification Service
     */
    @Operation(
        summary = "Получить версию сервиса",
        description = "Возвращает информацию о версии Notification Service (build time, git commit, версии)"
    )
