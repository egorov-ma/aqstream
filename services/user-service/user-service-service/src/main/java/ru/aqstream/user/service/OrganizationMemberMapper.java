...
/**
 * Маппер для преобразования OrganizationMember entity в DTO.
 */
@Mapper(componentModel = MappingConstants.ComponentModel.SPRING)
public interface OrganizationMemberMapper {

    /**
     * Преобразует OrganizationMember entity в DTO.
     *
     * @param member сущность члена организации
     * @return DTO члена организации
     */
    ...
    OrganizationMemberDto toDto(OrganizationMember member);

    /**
     * Форматирует имя пользователя.
     *
     * @param member член организации
     * @return полное имя пользователя
     */
    default String formatUserName(OrganizationMember member) {
     ...
     */
    default String formatInvitedByName(OrganizationMember member) {
