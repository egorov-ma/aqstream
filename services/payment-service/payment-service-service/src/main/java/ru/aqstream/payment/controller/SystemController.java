package ru.aqstream.payment.controller;
...
/**
 * Контроллер системной информации Payment Service.
...
public class SystemController {
     ...
     *
     * @return информация о версии Payment Service
     */
    @Operation(
        summary = "Получить версию сервиса",
        description = "Возвращает информацию о версии Payment Service (build time, git commit, версии)"
    )
