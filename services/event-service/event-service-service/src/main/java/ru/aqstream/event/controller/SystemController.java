...
/**
 * Контроллер системной информации Event Service.
...
public class SystemController {
     ...
     *
     * @return информация о версии Event Service
     */
    @Operation(
        summary = "Получить версию сервиса",
        description = "Возвращает информацию о версии Event Service (build time, git commit, версии)"
    )
