...
/**
 * Контроллер системной информации Media Service.
...
public class SystemController {
     ...
     *
     * @return информация о версии Media Service
     */
    @Operation(
        summary = "Получить версию сервиса",
        description = "Возвращает информацию о версии Media Service (build time, git commit, версии)"
    )
